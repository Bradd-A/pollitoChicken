            ...
            <div class="row min-vh-100 flex-column flex-md-row">
                ...
                <main class="col px-0 flex-grow-1 p-3 ">
                    <div class="container py-3">
                        <h3><i class="fas fa-id-badge"></i> MOSTRAR EMPLEADOS</h3>
                    ...
                    <div class="column w-100 bg-light p-4" id="info">
                        <h3> <i class="far fa-id-card"></i> EMPLEADOS ACTUALES</h3> <br> 
                        <a role="button" href="View/AgregarEmpleado.jsp" class="btn btn-dark">Agregar</a>
                        <div class="row pt-3">
                                ...
                                <table class="table table-striped table-sm">
                                    ...
                                    <%
                                        ...
                                        for (int i = 0; i < lista.size(); i++) {
                                            EmpleadosBeans em = lista.get(i);
                                    %>
                                    <tr class="text-center">
                                        <td><%=em.getID_EMPLEADO()%></td>
                                        <td><%=em.getNOM_EMPLE()%></td>
                                        <td><%=em.getAPE_EMPLE()%></td>
                                        <td><%=em.getROL()%></td>
                                        <td><%=em.getCORRE_EMPLE()%></td>
                                        <td><%=em.getPASS_EMPLE()%></td>
                                         <td>
                                             <a href="ServletEmpleado?op=eliminar&cod=<%=em.getID_EMPLEADO()%>" class="btn btn-danger" role="button" >
                                                 ELIMINAR
                                             </a>
                                             <a href="ServletEmpleado?op=consultarCod&cod=<%=em.getID_EMPLEADO()%>" role="button" class="btn btn-success">  
                                                 MODIFICAR
                                             </a>
                                         </td>
                                    </tr>
