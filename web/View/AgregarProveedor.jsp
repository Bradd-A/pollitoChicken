                            ...
                            <div class="row"> 
                                <div class="col-md-6  ">
                                    ...
                                    <div class="form-floating mt-2">
                                         <input type="number"  min="0" max="999999999"  name="txtTelf" class="form-control" id="floatingInput">
                                        <label for="floatingInput">Telefono del Proveedor</label>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="form-floating ">
                                        <input type="text" name="txtDirec" class="form-control" id="floatingInput">
