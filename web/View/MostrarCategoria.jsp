            ...
            <div class="row min-vh-100 flex-column flex-md-row">
                ...
                <main class="col px-0 flex-grow-1 p-3 pb-4">
                    <div class="container py-3">
                        <h2><i class="fa fa-cubes"></i> MOSTRAR CATEGORIAS</h2>
                        <p class="text lead">En este módulo mostrará las categorias existentes dentro del sistemas correspondientes a los productos.</p>
                    </div>
                    <div class="column w-100  bg-light p-4" id="info">
                        <h2> <i class="fa fa-truck"></i> CATEGORIAS DISPONIBLES</h2>
                        <a role="button" href="View/AgregarCategoria.jsp" class="btn btn-dark">Agregar</a>
                        <div class="row pt-3" style="overflow-x:auto;">
                            <table class="table table-striped table-sm " width="100%">
                                ...
                                <%
                                    ArrayList<CategoriaBeans> lista = (ArrayList<CategoriaBeans>) request.getAttribute("lista");
                                    for (int i = 0; i < lista.size(); i++) {
                                        CategoriaBeans em = lista.get(i);
                                %>
                                <tr class="text-center">
                                    ...
                                    <th>
                                        <a href="ServletCategoria?op=eliminar&cod=<%=em.getID_CATEGORIA()%>" class="btn btn-danger" role="button">ELIMINAR</a>
                                        <a href="ServletCategoria?op=consultarCod&cod=<%=em.getID_CATEGORIA()%>" class="btn btn-success" role="button">MODIFICAR</a>
                                    </th>
                                </tr>
                                <%
                                    }
