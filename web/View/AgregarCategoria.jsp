            ...
            <div class="row min-vh-100 flex-column flex-md-row">
                ...
                <main class="col px-0 flex-grow-1 p-3 pb-4">
                    <div class="container py-3">
                        <h3><i class="fas fa-id-badge"></i> NUEVA CATEGORIA</h3>
                        <p class="text lead">En este módulo se ingresaran nuevas categorias al sistema de acuerdo a los productos en stock.</p>
                    </div> <br>
                    <div class="container bg-light pt-4" id="info">
                        ...
                        <form action="../ServletCategoria">  
                            <div class="row"> 
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-floating ">
                                        <input type="text" name="txtDescrip" class="form-control" id="floatingInput" placeholder="Apellidos">
