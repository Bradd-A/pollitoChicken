        ...
        <div class="container-fluid">
            <div class="row min-vh-100 flex-column flex-md-row">
                ...
                <main class="col px-0 flex-grow-1 p-3 pb-4"> 
                    <form action="ServletCategoria">
                        <div class="container py-3">
                            <h3><i class="fas fa-id-badge"></i> EDITAR CATEGORIA</h3>
                            <p class="text lead">En este módulo podrás editar las categorias registradas en el sistema.</p>
                        </div>
                        <div class="container bg-light pt-4" id="info">
                            <h3> <i class="far fa-id-card"></i> INFORMACIÓN  DE LA CATEGORIA</h3> <br>
                            <div class="row"> 
                                <%
                                    ArrayList<CategoriaBeans> lista
                                            = (ArrayList<CategoriaBeans>) request.getAttribute("lista");
                                    for (int i = 0; i < lista.size(); i++) {
                                        CategoriaBeans eb = lista.get(i);
                                %>
                                <div class="col-md-6  ">
                                    <div class="form-floating">
                                        <input type="text" name="txtCod"  readonly="readonly" class="form-control" id="floatingInput" value="<%=eb.getID_CATEGORIA()%>" >
                                        <label for="floatingInput">Codigo</label><br>
                                    </div>
                                    <div class="form-floating">
                                        <input type="text" name="txtNom" class="form-control" value="<%=eb.getNOM_CAT()%>" id="floatingInput">
                                        <label for="floatingInput">Nombres</label><br>
                                    </div>
                                <div class="form-floating mb-2 mt-2">
                                        <input type="text" name="txtDescrip" class="form-control" value="<%=eb.getDESCRIPCION()%>" id="floatingInput">
                                        <label for="floatingInput">Descripcion</label><br>
                                    </div>                   
                                </div>
                                </div>
                            <input type="hidden" name="op" value="editar">
                            <input type="Submit" name="btn" class=" btn btn-dark" value="Guardar Cambios"><br>
                        </div>                      
                    </form>
                    <%
                        }
